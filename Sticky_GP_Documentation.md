...
## 2. Multi-Character Support (V6 Architecture)

In Version 6, the architecture was drastically refactored to seamlessly support multiple Grease Pencil objects targeting multiple unique meshes simultaneously (e.g., Character A binds to Mesh A, Character B binds to Mesh B).
